...
const sourceTreeIconFileNames = {
  ...
  nilox: {
    ico: "t3-nilox-windows.ico",
    macPng: "nilox-macos-1024.png",
    universalPng: "nilox-universal-1024.png",
  },
} as const;
...
function resolveSourceTreeIconPath(
  ...
  const brand =
    environment.distribution.id === "nilox" ? "nilox" : environment.isDevelopment ? "dev" : "prod";
