...
/**
 * Folds parsed transcript records into `(source, day, hourStart?, provider, model)`
 * buckets.
 *
...
export class UsageAggregator {
   ...
   */
  add(record: UsageRecord, sourceIndex = 0): boolean {
    ...
    const key = `${sourceIndex}\u0000${day}\u0000${hourStart}\u0000${record.provider}\u0000${record.model}`;
